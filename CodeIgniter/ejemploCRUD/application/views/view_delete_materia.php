...
?><div id="container">
	...
	echo form_open();
	  ...
	  echo '<tr>';
	  echo "<td height='10' class='tabla_ventanas_login' height='10' colspan='3'><legend align='center'>Eliminar Materia: ".$datos_materia[0]->NOMBRE."</legend></td>";
	  echo '</tr>';
