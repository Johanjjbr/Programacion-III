...
?><div id="container">
	...
	echo form_open();
	  ...
	  echo '<tr>';
	  echo "<td height='10' class='tabla_ventanas_login' height='10' colspan='3'><legend align='center'>Eliminar Alumno: ".$datos_alumno[0]->NOMBRE.' '.$datos_alumno[0]->APELLIDO."</legend></td>";
	  echo '</tr>';
